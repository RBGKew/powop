...
create table Lifeform (Lifeform_id integer not null, Lifeform_abbreviation varchar(255), Lifeform_description varchar(255), primary key (Lifeform_id));
