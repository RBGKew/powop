...
public class SynonymsIntegrationTest extends AbstractPersistenceTestSupport{
	...
	public void testGetSynonyms() {
		...
		assertEquals("We should have 2 heterotypic synonyms", 2, heterotypicSynonyms.size());
		assertEquals("We should have 3 homotypic synonyms", 2, homotypicSynonyms.size());
	}
