...
public class AbstractPersistenceTestSupport {
	...
	/**
	    *
	    */
	private static Logger logger = LoggerFactory.getLogger(ChecklistTriggerIntegrationTest.class);
	/**
	    *
	    */
	...
	public final void setUp() throws IOException, ClassNotFoundException,
			...
			DatabaseUnitException, SQLException {
			    ...
			    = new ClassPathResource("org/emonocot/checklist/persistence/" + this.getClass().getSimpleName() + ".xml");
	 ...
	 */
	protected final IDatabaseConnection getConnection(final Connection connection) throws SQLException {
	 ...
	 * @throws DataSetException if there is a problem with DBUnit
	 */
	public final void printDataSet(final OutputStream out, final String[] tableNames)
