   ...
   private static final DateTime DATE_TIME
    ...
    public final void doSetup(final Map model) {
        ...
        model.put("resumptionToken",
                new ResumptionToken(ListRecordsViewTest.NUMBER_OF_ENTITIES,0,
