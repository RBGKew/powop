 ...
 *
 */
public class ListRecordsViewTest extends AbstractOaiPmhViewTestCase {
   ...
   private static final DateTime DATE_TIME
    ...
    public final void doSetup(final Map model) {
        ...
        for (int i = 0; i < ListRecordsViewTest.NUMBER_OF_ENTITIES; i++) {
            ...
            list.add(new ChangeEventImpl<IdentifiableEntity>(entity,
                    ChangeType.CREATE, ListRecordsViewTest.DATE_TIME));
        }
        Page<ChangeEvent<IdentifiableEntity>> results
            = new DefaultPageImpl<ChangeEvent<IdentifiableEntity>>(
                    ListRecordsViewTest.TOTAL_NUMBER_OF_ENTITIES, 0,
                    ListRecordsViewTest.NUMBER_OF_ENTITIES, list);
        model.put("object", results);

        model.put("resumptionToken",
                new ResumptionToken(
                        ListRecordsViewTest.TOTAL_NUMBER_OF_ENTITIES,
                        ListRecordsViewTest.NUMBER_OF_ENTITIES,0,
                        ListRecordsViewTest.DATE_TIME,
                        ListRecordsViewTest.DATE_TIME,
