...
public class GetRecordViewTest extends AbstractOaiPmhViewTestCase {
    ...
    public final void doSetup(final Map model) {
        ...
        Publication publication = new Publication(
                ...
                null, "Missouri Botanic Garden", PublicationType.JOURNAL, 1);

        taxon.getCitations()
                .add(new Article(
                        "Luer, C.A.",
                        "Icones Pleurothallidinarum XXVIII. A reconsideration of Masdevallia, systematics of Specklinia and vegetatively similar taxa (Orchidaceae)",
                        publication, 2, "105", "1", "281", "2006"));
...
//
//        synonym = new Taxon();
//        synonym.setIdentifier("urn:kew.org:wcs:taxon:2047");
//        synonym.setName("Agrostis capillaris repens (Laest.)"
//                      + " Soják, Cas. Nár. Mus.");
//        synonym.setBasionym(taxon.getBasionym());
//        synonyms.add(synonym);
    ...
    public final String getExpected() {
    	return "<?xml version='1.0' encoding='UTF-8' standalone='yes'?><?xml-stylesheet type='text/xsl' href='oai2.xsl'?><oai:OAI-PMH xmlns:oai=\"http://www.openarchives.org/OAI/2.0/\" xmlns:oai__dc=\"http://www.openarchives.org/OAI/2.0/oai_dc/\" xmlns:dc=\"http://purl.org/dc/elements/1.1/\" xmlns:tc=\"http://rs.tdwg.org/ontology/voc/TaxonConcept#\" xmlns:rdf=\"http://www.w3.org/1999/02/22-rdf-syntax-ns#\" xmlns:tn=\"http://rs.tdwg.org/ontology/voc/TaxonName#\" xmlns:owl=\"http://www.w3.org/2002/07/owl#\" xmlns:dcterms=\"http://purl.org/dc/terms/\" xmlns:tcom=\"http://rs.tdwg.org/ontology/voc/Common#\" xmlns:tpub=\"http://rs.tdwg.org/ontology/voc/PublicationCitation#\" xmlns:tp=\"http://rs.tdwg.org/ontology/voc/Person#\" xmlns:tt=\"http://rs.tdwg.org/ontology/voc/Team#\" xmlns:spm=\"http://rs.tdwg.org/ontology/voc/SpeciesProfileModel#\" xmlns:spmi=\"http://rs.tdwg.org/ontology/voc/SPMInfoItems#\" xmlns:gr=\"http://rs.tdwg.org/ontology/voc/GeographicRegion#\" xmlns:em=\"http://volatile.e-monocot.org/tdwg/rs/ontology/voc/EMInfoItem#\"><oai:responseDate>2012-01-23T16:13:59Z</oai:responseDate><oai:request verb=\"GetRecord\"></oai:request><oai:GetRecord><oai:record><oai:header><oai:identifier>urn:kew.org:wcs:taxon:2043</oai:identifier><oai:datestamp>2005-04-25T11:00:00Z</oai:datestamp></oai:header><oai:metadata><tc:TaxonConcept xmlns:tc=\"http://rs.tdwg.org/ontology/voc/TaxonConcept#\"><dc:identifier xmlns:dc=\"http://purl.org/dc/elements/1.1/\">urn:kew.org:wcs:taxon:2043</dc:identifier><tcom:publishedInCitation xmlns:tcom=\"http://rs.tdwg.org/ontology/voc/Common#\"><tpub:PublicationCitation xmlns:tpub=\"http://rs.tdwg.org/ontology/voc/PublicationCitation#\"><dc:identifier>urn:kew.org:wcs:publicationEdition:2</dc:identifier><tpub:title>Icones Pleurothallidinarum XXVIII. A reconsideration of Masdevallia, systematics of Specklinia and vegetatively similar taxa (Orchidaceae)</tpub:title><tpub:authorship>Luer, C.A.</tpub:authorship><tpub:parentPublication><tpub:PublicationCitation><dc:identifier>urn:kew.org:wcs:publication:1</dc:identifier><tpub:title>Monographs in Systematic Botany from the Missouri Botanical Garden</tpub:title><tpub:publisher>Missouri Botanic Garden</tpub:publisher><tpub:publicationType rdf:resource=\"http://rs.tdwg.org/ontology/voc/PublicationCitation#Journal\"></tpub:publicationType></tpub:PublicationCitation></tpub:parentPublication><tpub:publicationType rdf:resource=\"http://rs.tdwg.org/ontology/voc/PublicationCitation#JournalArticle\"></tpub:publicationType><tpub:volume>105</tpub:volume><tpub:pages>1 - 281</tpub:pages><tpub:datePublished>2006</tpub:datePublished></tpub:PublicationCitation></tcom:publishedInCitation><tc:status rdf:resource=\"http://e-monocot.org/TaxonomicStatus#accepted\"></tc:status><tc:hasName><tn:TaxonName xmlns:tn=\"http://rs.tdwg.org/ontology/voc/TaxonName#\"><dc:identifier>urn:lsid:ipni.org:names:385550-1:1.4</dc:identifier><tcom:microReference>1: 62.</tcom:microReference><tcom:publishedInCitation><tpub:PublicationCitation xmlns:tpub=\"http://rs.tdwg.org/ontology/voc/PublicationCitation#\"><dc:identifier>urn:kew.org:wcs:placeOfPublication:1</dc:identifier><tpub:title>Sp. Pl.</tpub:title><tpub:authorship>Linnaeus</tpub:authorship><tpub:publicationType rdf:resource=\"http://rs.tdwg.org/ontology/voc/PublicationCitation#Generic\"></tpub:publicationType><tpub:datePublished>1753</tpub:datePublished></tpub:PublicationCitation></tcom:publishedInCitation><tn:authorship>L.</tn:authorship><tn:combinationAuthorship>L.</tn:combinationAuthorship><tn:nameComplete>Agrostis capillaris</tn:nameComplete><tn:rank rdf:resource=\"http://rs.tdwg.org/ontology/voc/TaxonRank#Species\"></tn:rank><tn:rankString>Species</tn:rankString></tn:TaxonName></tc:hasName><tc:hasRelationship><tc:Relationship><tc:relationshipCategory rdf:resource=\"http://volatile.e-monocot.org/tdwg/rs/ontology/voc/TaxonConcept#HasBasionym\"></tc:relationshipCategory><tc:toTaxon rdf:resource=\"urn:kew.org:wcs:taxon:2045\"></tc:toTaxon></tc:Relationship></tc:hasRelationship><tc:describedBy><spm:SpeciesProfileModel xmlns:spm=\"http://rs.tdwg.org/ontology/voc/SpeciesProfileModel#\"><spm:aboutTaxon rdf:resource=\"urn:kew.org:wcs:taxon:2043\"></spm:aboutTaxon><spm:hasInformation><em:Habitat xmlns:em=\"http://volatile.e-monocot.org/tdwg/rs/ontology/voc/EMInfoItem#\"><spm:hasContent>Hanover House</spm:hasContent></em:Habitat></spm:hasInformation><spm:hasInformation><spmi:Distribution xmlns:spmi=\"http://rs.tdwg.org/ontology/voc/SPMInfoItems#\"><spm:hasValue rdf:resource=\"http://rs.tdwg.org/ontology/voc/GeographicRegion.rdf#DEN\"></spm:hasValue></spmi:Distribution></spm:hasInformation></spm:SpeciesProfileModel></tc:describedBy></tc:TaxonConcept></oai:metadata></oai:record></oai:GetRecord></oai:OAI-PMH>";
    }
