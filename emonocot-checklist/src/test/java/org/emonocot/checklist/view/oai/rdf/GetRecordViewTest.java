...
public class GetRecordViewTest extends AbstractOaiPmhViewTestCase {
    ...
    public final String getExpected() {
        return "<?xml version='1.0' encoding='UTF-8' standalone='yes'?><?xml-stylesheet type='text/xsl' href='oai2.xsl'?><oai:OAI-PMH xmlns:oai='http://www.openarchives.org/OAI/2.0/' xmlns:oai__dc='http://www.openarchives.org/OAI/2.0/oai_dc/' xmlns:dc='http://purl.org/dc/elements/1.1/' xmlns:tc='http://rs.tdwg.org/ontology/voc/TaxonConcept#' xmlns:rdf='http://www.w3.org/1999/02/22-rdf-syntax-ns#' xmlns:tn='http://rs.tdwg.org/ontology/voc/TaxonName#' xmlns:owl='http://www.w3.org/2002/07/owl#' xmlns:dcterms='http://purl.org/dc/terms/' xmlns:tcom='http://rs.tdwg.org/ontology/voc/Common#' xmlns:tpc='http://rs.tdwg.org/ontology/voc/PublicationCitation#' xmlns:tp='http://rs.tdwg.org/ontology/voc/Person#' xmlns:tt='http://rs.tdwg.org/ontology/voc/Team#' xmlns:spm='http://rs.tdwg.org/ontology/voc/SpeciesProfileModel#' xmlns:spmi='http://rs.tdwg.org/ontology/voc/SPMInfoItems#' xmlns:gr='http://rs.tdwg.org/ontology/voc/GeographicRegion#'><oai:responseDate>2011-05-18T16:53:42Z</oai:responseDate><oai:request verb='GetRecord'></oai:request><oai:GetRecord><oai:record><oai:header><oai:identifier>urn:kew.org:wcs:taxon:2043</oai:identifier><oai:datestamp>2005-04-25T11:00:00Z</oai:datestamp></oai:header><oai:metadata><tc:TaxonConcept xmlns:tc='http://rs.tdwg.org/ontology/voc/TaxonConcept#'><dc:identifier xmlns:dc='http://purl.org/dc/elements/1.1/'>urn:kew.org:wcs:taxon:2043</dc:identifier><tc:hasName><tn:TaxonName xmlns:tn='http://rs.tdwg.org/ontology/voc/TaxonName#'><dc:identifier>urn:lsid:ipni.org:names:385550-1:1.4</dc:identifier><tn:authorship>L.</tn:authorship><tn:combinationAuthorship>L.</tn:combinationAuthorship><tn:nameComplete>Agrostis capillaris</tn:nameComplete><tn:rank rdf:resource=\"http://rs.tdwg.org/ontology/voc/TaxonRank#Species\"></tn:rank><tn:rankString>Species</tn:rankString></tn:TaxonName></tc:hasName><tc:hasRelationship><tc:Relationship><tc:relationshipCategory rdf:resource='http://rs.tdwg.org/ontology/voc/TaxonConcept#HasSynonym'></tc:relationshipCategory><tc:toTaxon rdf:resource='urn:kew.org:wcs:taxon:2046'></tc:toTaxon></tc:Relationship></tc:hasRelationship><tc:hasRelationship><tc:Relationship><tc:relationshipCategory rdf:resource='http://rs.tdwg.org/ontology/voc/TaxonConcept#HasSynonym'></tc:relationshipCategory><tc:toTaxon rdf:resource='urn:kew.org:wcs:taxon:2045'></tc:toTaxon></tc:Relationship></tc:hasRelationship><tc:describedBy><spm:SpeciesProfileModel xmlns:spm='http://rs.tdwg.org/ontology/voc/SpeciesProfileModel#'><spm:aboutTaxon rdf:resource='urn:kew.org:wcs:taxon:2043'></spm:aboutTaxon><spm:hasInformation><spmi:Distribution xmlns:spmi='http://rs.tdwg.org/ontology/voc/SPMInfoItems#'><spm:hasValue rdf:resource='http://rs.tdwg.org/ontology/voc/GeographicRegion.rdf#SWE'></spm:hasValue></spmi:Distribution></spm:hasInformation><spm:hasInformation><spmi:Distribution xmlns:spmi='http://rs.tdwg.org/ontology/voc/SPMInfoItems#'><spm:hasValue rdf:resource='http://rs.tdwg.org/ontology/voc/GeographicRegion.rdf#NOR'></spm:hasValue></spmi:Distribution></spm:hasInformation><spm:hasInformation><spmi:Distribution xmlns:spmi='http://rs.tdwg.org/ontology/voc/SPMInfoItems#'><spm:hasValue rdf:resource='http://rs.tdwg.org/ontology/voc/GeographicRegion.rdf#DEN'></spm:hasValue></spmi:Distribution></spm:hasInformation></spm:SpeciesProfileModel></tc:describedBy></tc:TaxonConcept></oai:metadata></oai:record></oai:GetRecord></oai:OAI-PMH>";
    }
