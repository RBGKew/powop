 ...
 *
 */
public class TaxonStatusUserType implements UserType {
    /**
     *
     */
    private static Logger logger
        = LoggerFactory.getLogger(TaxonStatusUserType.class);
    ...
    public final boolean equals(final Object x, final Object y) {
         ...
         TaxonStatus statusX = (TaxonStatus) x;
         TaxonStatus statusY = (TaxonStatus) y;
    ...
    public final Object nullSafeGet(final ResultSet resultSet,
        ...
        String identifier = (String) StandardBasicTypes.STRING.nullSafeGet(
                resultSet, string);
        if(identifier == null) {
            return null;
        }
        try {
            TaxonStatus result = TaxonStatus.valueOf(identifier);
            return result;
    ...
    public final void nullSafeSet(final PreparedStatement preparedStatement,
        ...
        if (value == null) {
            ...
            TaxonStatus r = ((TaxonStatus) value);
            StandardBasicTypes.STRING
              .nullSafeSet(preparedStatement, r.name(), index);
        }
    }
