...
import org.powo.job.dwc.read.ArchiveUnpacker;
...
public class ArchiveUnpackerTest {
	...
	private String unpackDirectoryName = System.getProperty("java.io.tmpdir") + "/archive";
	...
	public final void testUnpack() throws Exception {
		...
		archiveUnpacker.unpackArchive(content.getFile().getAbsolutePath(), unpackDirectoryName);
