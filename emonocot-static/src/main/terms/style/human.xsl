     ...
     <xsl:template match="/*">
          ...
          <html>
               <head>
                    ...
                    <link rel="stylesheet" type="text/css" href="http://e-monocot.org/css/style.css"/>
               </head>
               <body>
                   <div class="navbar navbar-inverse navbar-fixed-top">
                     <div class="navbar-inner">
                       <div class="container"><a href="/" class="brand"><span>eMonocot</span></a></div>
                     </div>
                    </div>
                    ...
                    <div style="font-size:80%;color:#888;">
                         <table>
							...
							<xsl:choose>
                              ...
                              <tr><th>Ignored by eMonocot</th><td><xsl:value-of select="@ignored"/></td></tr>
                         </table>
                    </div>
               </td>
          </tr>
