 ...
 *
 */
public class IdentifierValidator extends DarwinCoreValidator<Identifier> {
     ...
     *
     */
    private Logger logger = LoggerFactory.getLogger(IdentifierValidator.class);
    ...
    public final Identifier process(final Identifier identifier)
        ...
        if (identifier.getTaxon() == null) {
            throw new NoTaxonException(identifier + " has no Taxon set",
                    RecordType.Identifier, getStepExecution().getReadCount());
        }
