 ...
 *
 */
public class EoLTransferSchemaQNameMapFactory extends
     ...
     *
     * @return a map containing qnames from the eol transfer schema
     * namespace.
     */
    @Override
    protected final QNameMap createInstance() {
        ...
        qNameMap.registerMapping(new QName(
                "http://www.eol.org/transfer/content/0.3", "taxon"),
                EoLTaxonItem.class);
        qNameMap.registerMapping(new QName(
                "http://www.eol.org/transfer/content/0.3", "dataObject"),
                EoLDataObject.class);
