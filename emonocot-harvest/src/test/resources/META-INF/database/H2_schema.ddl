...
create table Concept (id bigint not null, identifier varchar(255), accessRights varchar(255), created timestamp, creator varchar(255), license varchar(255), modified timestamp, rights clob, rightsHolder varchar(255), prefLabel varchar(255), definition clob, altLabel varchar(255), authority_id bigint, prefSymbol_id bigint, source_id bigint, uri varchar(255), primary key (id), unique (identifier));
drop table if exists Description;
create table Description (id bigint not null, identifier varchar(255), accessRights varchar(255), created timestamp, creator varchar(255), license varchar(255), modified timestamp, rights clob, rightsHolder varchar(255), source varchar(255), description clob, type varchar(255), language varchar(32), contributor varchar(255), audience varchar(255), authority_id bigint, taxon_id bigint, uri varchar(255), primary key (id), unique (identifier));
