...
create table Resource (id bigint not null, identifier varchar(255), duration timestamp, exitDescription clob, exitCode varchar(255), jobId bigint, jobInstance varchar(255), jobType varchar(255), lastHarvested timestamp, processSkip integer, recordsRead integer, readSkip integer, resource varchar(255), startTime timestamp, status varchar(255), uri varchar(255), writeSkip integer, written integer, organisation_id bigint, primary key (id), unique (identifier));
