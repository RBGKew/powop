...
create table Annotation (id bigint generated by default as identity, identifier varchar(255), annotatedObjId bigint, annotatedObjType varchar(255), code varchar(255), dateTime integer, jobId bigint, text clob, type varchar(255), recordType varchar(255), value varchar(255), source_id bigint, primary key (id));
