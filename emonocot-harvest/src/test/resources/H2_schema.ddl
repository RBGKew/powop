...
create table Taxon (id bigint not null, created timestamp, creator varchar(255), identifier varchar(255), license varchar(255), modified timestamp, source varchar(255), authorship varchar(255), basionymAuthorship varchar(255), genus varchar(255), infraSpecificEpithet varchar(255), name varchar(255), rank varchar(255), specificEpithet varchar(255), uninomial varchar(255), accepted_id bigint, parent_id bigint, primary key (id));
