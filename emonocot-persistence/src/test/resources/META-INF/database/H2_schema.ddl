...
create table Image (id bigint not null, identifier varchar(255), accessRights varchar(255), created timestamp, creator varchar(255), license varchar(255), modified timestamp, rights varchar(255), rightsHolder varchar(255), references varchar(255), caption varchar(255), description clob, format varchar(255), keywords varchar(255), location BLOB, locality varchar(255), url varchar(255), authority_id bigint, image_id bigint, taxon_id bigint, primary key (id), unique (identifier));
