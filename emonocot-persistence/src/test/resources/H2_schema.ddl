...
create table Taxon (id bigint not null, identifier varchar(255), created timestamp, creator varchar(255), license varchar(255), modified timestamp, source varchar(255), accordingTo varchar(128), authorship varchar(128), basionymAuthorship varchar(128), family varchar(128), genus varchar(128), infraGenericEpithet varchar(128), infraSpecificEpithet varchar(128), kingdom varchar(128), name varchar(128), nomenclaturalCode varchar(255), ordr varchar(128), phylum varchar(128), protologueMicroReference varchar(128), rank varchar(255), specificEpithet varchar(128), status varchar(255), uninomial varchar(128), authority_id bigint, image_id bigint, accepted_id bigint, parent_id bigint, protologue_id bigint, primary key (id), unique (identifier));
