create table Annotation (id bigint generated by default as identity, annotatedObjId bigint, annotatedObjType varchar(255), code varchar(255), jobId bigint, present boolean not null default 0, text varchar(255), primary key (id));
