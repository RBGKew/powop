						...
						<li id="${facetName}">
							...
							<ul class="facet">
								<jsp:scriptlet>
									...
									pageContext.setAttribute("facetSelected",
									new Boolean(result.isFacetSelected(facetName)));
								</jsp:scriptlet>
								<c:choose>
									<c:when test="${facetSelected}">
										...
										<li>
											<jsp:scriptlet>try {
												...
												pageContext.setAttribute("selectedFacetName",
												facet.getValue());
												} catch (Exception e) {
													pageContext
													.setAttribute("selectedFacetName",
													"Unable to display name of selected option");
												}
											</jsp:scriptlet>
