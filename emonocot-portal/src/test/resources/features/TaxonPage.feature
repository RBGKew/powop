...
Background:
  ...
  | identifier                   | name                        | status   | parent                     | accepted                   | protologue                    | protologueMicroReference | protologLink                                                         | distribution1 | diagnostic                                                          | habitat                                                                                   | diagnosticReference1          | 
  | urn:kew.org:wcs:family:3     | Araceae                     | accepted |                            |                            |                               |                          |                                                                      |               |                                                                     |                                                                                           |                               |
  | urn:kew.org:wcs:taxon:2295   | Acorus                      | accepted |                            |                            | urn:kew.org:wcs:publication:1 | : 324                    | http://wp5.e-taxonomy.eu/media/palmae/protologe/palm_tc_100447_P.pdf | MAU           | These grasslike evergreen plants are hemicryptophytes or geophytes. | Their natural habitat is at the waterside or close to marshes, often found with reedbeds. | urn:kew.org:wcs:publication:1 |
  | urn:kew.org:wcs:taxon:2304   | Acorus calamus              | accepted | urn:kew.org:wcs:taxon:2295 |                            |                               |                          |                                                                      |               |                                                                     |                                                                                           |                               |
  | urn:kew.org:wcs:taxon:2309   | Acorus calamus var. calamus | accepted | urn:kew.org:wcs:taxon:2304 |                            |                               |                          |                                                                      |               |                                                                     |                                                                                           |                               |
  | urn:kew.org:wcs:taxon:109275 | Lemna                       | accepted | urn:kew.org:wcs:family:3   |                            |                               |                          |                                                                      | FOR           |                                                                     |                                                                                           |                               |
  | urn:kew.org:wcs:taxon:29332  | Calamus                     | synonym  |                            | urn:kew.org:wcs:taxon:2295 |                               |                          |                                                                      |               |                                                                     |                                                                                           |                               |
  | urn:kew.org:wcs:taxon:65181  | Dunalia artensis            | unplaced |                            |                            |                               |                          |                                                                      |               |                                                                     |                                                                                           |                               |
  And there are references with the following properties:
  | identifier                    | authors                      | title                                                        | datePublished | volume | page  | citation                | publisher                                               | taxa1                      |
  | urn:kew.org:wcs:publication:2 |                              | Sp. Pl.                                                      | (1753)        | 1      | 304pp | Sp. Pl. (1753): 1 304pp |                                                         | urn:kew.org:wcs:taxon:2295 | 
  | urn:kew.org:wcs:publication:3 | Govaerts, R. & Frodin, D.G.  | World Checklist and Bibliography of Araceae (and Acoraceae)  | 2002          |        | 1-560 |                         | The Board of Trustees of the Royal Botanic Gardens, Kew | urn:kew.org:wcs:taxon:2295 |
