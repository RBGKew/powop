...
Background:
  ...
  | identifier                   | name                        | status   | parent                     | protologue                    | protologueMicroReference | protologLink                                                         | distribution1 | diagnostic                                                          | habitat                                                                                   | image1 | image2 | image3 | diagnosticReference1          | reference1                    | reference2                    |
  ...
  | urn:kew.org:wcs:taxon:29332  | Calamus                     | synonym  |                            |                               |                          |                                                                      |               |                                                                     |                                                                                           |        |        |        |                               |                               |                               |
