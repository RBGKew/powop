...
Background:
  ...
  | identifier                   | name                        | status   | source | parent                     | accepted                   | protologue                    | protologueMicroReference | protologLink                                                         | distribution1 | distributionSource | distributionLicense | distributionRights | diagnostic                                                           | diagnosticSource | diagnosticLicense | diagnosticRights   | habitat                                                                                   | diagnosticReference1          | habitatSource | habitatLicense | habitatRights | lifeForm | iucnConservationStatus | uri          |
  | urn:kew.org:wcs:family:3     | Araceae                     | Accepted | test   |                            |                            |                               |                          |                                                                      |               |                    |                     |                    |                                                                      |                  |                   |                    |                                                                                           |                               |               |                |               |          |                        |              |
  | urn:kew.org:wcs:taxon:2295   | Acorus                      | Accepted | test   |                            |                            | Sp. Pl. 1: 324 (1753)         | : 324                    | http://wp5.e-taxonomy.eu/media/palmae/protologe/palm_tc_100447_P.pdf | MAU           | test3              | License1            | Rights1            | These grasslike evergreen plants are hemicryptophytes or geophytes.  | test2            | License3          | Rights3            | Their natural habitat is at the waterside or close to marshes, often found with reedbeds. | urn:kew.org:wcs:publication:1 | test2         | License2       | Rights2       |          |                        | http://test-url.com |
...
Scenario: Display textual data in sections
  ...
  Then there should be a paragraph "These grasslike evergreen plants are hemicryptophytes or geophytes. [PPWO.B][2]" with the heading "Diagnostic Description"
  And there should be a paragraph "Their natural habitat is at the waterside or close to marshes, often found with reedbeds. [PPWO.A]" with the heading "Habitat"
