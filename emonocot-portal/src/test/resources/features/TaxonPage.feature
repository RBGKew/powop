...
Background:
  ...
  | identifier                   | name                        | status   | parent                     | accepted                   | protologue                    | protologueMicroReference | protologLink                                                         | distribution1 | diagnostic                                                          | habitat                                                                                   | diagnosticReference1          | reference1                    | reference2                    |
  | urn:kew.org:wcs:family:3     | Araceae                     | accepted |                            |                            |                               |                          |                                                                      |               |                                                                     |                                                                                           |                               |                               |                               |
  | urn:kew.org:wcs:taxon:2295   | Acorus                      | accepted |                            |                            | urn:kew.org:wcs:publication:1 | : 324                    | http://wp5.e-taxonomy.eu/media/palmae/protologe/palm_tc_100447_P.pdf | MAU           | These grasslike evergreen plants are hemicryptophytes or geophytes. | Their natural habitat is at the waterside or close to marshes, often found with reedbeds. | urn:kew.org:wcs:publication:1 | urn:kew.org:wcs:publication:1 | urn:kew.org:wcs:publication:2 |
