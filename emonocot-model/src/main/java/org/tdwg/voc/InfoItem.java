...
public class InfoItem extends Description {
     ...
     *
     */
    private String spmHasContent = null;
     ...
     *
     * @param definedTerm
     *            Set the category of this information
     */
     ...
     *
     * @param definedTerms
     *            set the context of this info item
     */
    public final void setContext(final Set<DefinedTerm> definedTerms) {
        if (definedTerms != null) {
            ...
            for (DefinedTerm definedTerm : definedTerms) {
                spmContextValues
                        .add(new DefinedTermLinkType(definedTerm, false));
            }
        } else {
     ...
     *
     * @param definedTerm
     *            Add a term defining the context of this information to this
     *            info item
     */
     ...
     *
     * @param definedTerms
     *            Set the values in this info item
     */
