...
/**
 * User type which converts a date time into an integer suitable for use
 * as a foreign key related.
 *
 * Works off a starting date of the first of August 2011.
 * @author ben
 *
 */
public class OlapDateTimeUserType implements UserType {

    /**
     *
     */
    private static DateTime startDate = new DateTime(2011, 8, 1, 0, 0, 0, 0);
    ...
    public final Object nullSafeGet(final ResultSet resultSet,
        ...
        Integer i = (Integer) StandardBasicTypes.INTEGER.nullSafeGet(
                resultSet, string);
        if (i != null) {
    ...
    public final void nullSafeSet(final PreparedStatement preparedStatement,
        ...
        if (value == null) {
            ...
            StandardBasicTypes.INTEGER
              .nullSafeSet(preparedStatement, convert(d), index);
        }
    }
     ...
     * @return an integer representation of that datetime
     */
    public static Integer convert(final DateTime dateTime) {
        Days days = Days.daysBetween(startDate, dateTime);
        return days.getDays();
    }
