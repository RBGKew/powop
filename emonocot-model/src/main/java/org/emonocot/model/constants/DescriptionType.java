...
public enum DescriptionType {
	...
	spines("generalMorphology:spines"),
	stemMorphology("stemMorphology"),
	cladodes("stemMorphology:cladodes"),
	Wood("generalMorphology:Wood"),
	rootMorphology("rootMorphology"),
	leafMorphology("leafMorphology"),
	lamina("leafMorphology:lamina"),
	stipules("leafMorphology:stipules"),
	leafSheaths("leafMorphology:leaf-sheaths"),
	ligule("leafMorphology:ligule"),
	...
	bracteole("reproductiveMorphology:inflorescences:bracteole"),
	...
	scape("reproductiveMorphology:inflorescences:scape"),
	...
	epicalyx("reproductiveMorphology:flowers:epicalyx"),
	hypanthium("reproductiveMorphology:flowers:hypanthium"),
	perianth("reproductiveMorphology:flowers:perianth"),
	sterileParts("reproductiveMorphology:flowers:sterileParts"),
	staminodes("reproductiveMorphology:staminodes"),
	corolla("reproductiveMorphology:flowers:corolla"),
	corona("reproductiveMorphology:flowers:corona"),
	androecium("reproductiveMorphology:flowers:androecium"),
	disc("reproductiveMorphology:flowers:disc"),
	...
	infructescences("reproductiveMorphology:infructescences"),
	seeds("reproductiveMorphology:seeds"),
	germination("reproductiveMorphology:germination"),
