...
create table PhylogeneticTree (id bigint not null, accessRights varchar(255), created timestamp, creator varchar(255), identifier varchar(255) not null, license varchar(255), phylogeny clob, modified timestamp, rights clob, rightsHolder varchar(255), description clob, title varchar(255), authority_id bigint, primary key (id), unique (identifier));
