...
create table Comment (id bigint not null, identifier varchar(255), commentPage_id bigint, commentPage_type varchar(255), aboutData_id bigint, aboutData_type varchar(255), comment longtext, created datetime, status varchar(15), user_id bigint, inResponseTo_id bigint, primary key(id), unique(identifier));
