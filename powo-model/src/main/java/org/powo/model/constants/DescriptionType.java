...
public enum DescriptionType {
	...
	morphologyGeneralColour("morphology:general:colour"),
	...
	morphologyLeafPitcher("morphology:leaf:pitcher"),
	...
	morphologyReproductiveFruitCupule("morphology:reproductive:fruit:cupule"),
	...
	useFoodFermentingAgents("use:food:fermentingAgents"),
	...
	useInvertebrateFood("use:invertebrateFood"),
	...
	useMaterialsCosmetics("use:materials:cosmetics"),
	...
	useMedicinesAntioxidant("use:medicines:antioxidant"),
	...
	useMedicinesFever("use:medicines:fever"),
	...
	usePoisonsHousePestControl("use:poisons:housePestControl"),
	...
	usePoisonsLivestockPestControl("use:poisons:livestockPestControl"),
	...
	usePoisonsUnspecifiedMicrobes("use:poisons:unspecifiedMicrobes"),
	...
	public static final ImmutableMap<String, Set<DescriptionType>> searchCategories = ImmutableMap.<String, Set<DescriptionType>>builder()
			...
			.put("fruit", ImmutableSet.<DescriptionType>of(
					...
					morphologyReproductiveFruitCupule,
